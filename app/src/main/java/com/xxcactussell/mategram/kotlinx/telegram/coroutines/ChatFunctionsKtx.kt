 ...
 * canEditStories right in the chat. The stories are returned in reverse chronological order (i.e., in
 * order of decreasing storyId). For optimal performance, the number of returned stories is chosen by
 * TDLib.
 *
 * @param chatId Chat identifier.  
...
/**
 * Suspend function, which returns RTMP URL for streaming to the chat; requires canManageVideoChats
 * administrator right.
 *
 * @param chatId Chat identifier.
 *
