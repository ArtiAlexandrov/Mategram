...
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addChatMember
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addChatMembers
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addChatToList
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addFileToDownloads
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addLocalMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addMessageReaction
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addPendingPaidMessageReaction
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.addRecentlyFoundChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.banChatMember
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.boostChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.canSendStory
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.checkChatUsername
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.clickAnimatedEmojiMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.clickChatSponsoredMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.closeChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.commitPendingPaidMessageReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.createChatInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.createChatSubscriptionInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.createForumTopic
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.createVideoChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteAllRevokedChatInviteLinks
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteChatBackground
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteChatHistory
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteChatMessagesByDate
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteChatMessagesBySender
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteChatReplyMarkup
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteForumTopic
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.deleteRevokedChatInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editBusinessMessageCaption
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editBusinessMessageLiveLocation
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editBusinessMessageMedia
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editBusinessMessageReplyMarkup
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editBusinessMessageText
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editChatInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editChatSubscriptionInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editForumTopic
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editMessageCaption
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editMessageLiveLocation
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editMessageMedia
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editMessageReplyMarkup
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editMessageSchedulingState
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editMessageText
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.forwardMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getAllStickerEmojis
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getCallbackQueryAnswer
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getCallbackQueryMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatActiveStories
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatAdministrators
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatArchivedStories
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatAvailableMessageSenders
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatAvailablePaidMessageReactionSenders
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatBoostLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatBoostStatus
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatBoosts
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatEventLog
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatHistory
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatInviteLinkCounts
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatInviteLinkMembers
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatInviteLinks
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatJoinRequests
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatListsToAddChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatMember
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatMessageByDate
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatMessageCalendar
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatMessageCount
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatMessagePosition
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatPinnedMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatPostedToChatPageStories
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatRevenueStatistics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatRevenueTransactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatRevenueWithdrawalUrl
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatScheduledMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatSimilarChatCount
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatSimilarChats
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatSparseMessagePositions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatSponsoredMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getChatStatistics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getForumTopic
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getForumTopicLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getForumTopics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getGameHighScores
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getGiveawayInfo
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getInlineQueryResults
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getLoginUrl
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getLoginUrlInfo
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMainWebApp
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMapThumbnailFile
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageAddedReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageAvailableReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageEmbeddingCode
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageImportConfirmationText
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageLocally
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageProperties
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessagePublicForwards
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageReadDate
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageStatistics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageThread
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageThreadHistory
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessageViewers
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getPaymentReceipt
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getPollVoters
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getRepliedMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getStatisticalGraph
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getStickers
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getStoryStatistics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getUserChatBoosts
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getVideoChatAvailableParticipants
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getVideoChatRtmpUrl
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getWebAppLinkUrl
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.importMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.joinChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.leaveChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.openChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.openChatSimilarChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.openMessageContent
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.openWebApp
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.pinChatMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.processChatJoinRequest
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.processChatJoinRequests
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.rateSpeechRecognition
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.readAllChatMentions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.readAllChatReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.readAllMessageThreadMentions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.readAllMessageThreadReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.recognizeSpeech
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.removeBusinessConnectedBotFromChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.removeChatActionBar
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.removeMessageReaction
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.removePendingPaidMessageReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.removeRecentlyFoundChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.removeTopChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.replacePrimaryChatInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.replaceVideoChatRtmpUrl
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.reportChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.reportChatPhoto
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.reportChatSponsoredMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.reportMessageReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.resendMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.revokeChatInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.saveApplicationLogEvent
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.searchChatMembers
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.searchChatMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.searchChatRecentLocationMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.searchSecretMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendBotStartMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendBusinessMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendBusinessMessageAlbum
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendChatAction
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendInlineQueryResultMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendMessageAlbum
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendQuickReplyShortcutMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendStory
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setBusinessMessageIsPinned
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatAccentColor
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatActiveStoriesList
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatAffiliateProgram
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatAvailableReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatBackground
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatClientData
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatDescription
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatDiscussionGroup
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatDraftMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatEmojiStatus
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatLocation
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatMemberStatus
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatMessageAutoDeleteTime
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatMessageSender
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatNotificationSettings
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatPaidMessageStarCount
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatPermissions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatPhoto
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatPinnedStories
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatProfileAccentColor
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatSlowModeDelay
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatTheme
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setChatTitle
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setForumTopicNotificationSettings
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setGameScore
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setMessageFactCheck
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setMessageReactions
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setPaidMessageReactionType
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setPersonalChat
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setPinnedForumTopics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setPollAnswer
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setVideoChatDefaultParticipant
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.shareChatWithBot
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.shareUsersWithBot
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.stopBusinessPoll
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.stopPoll
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleBusinessConnectedBotChatIsPaused
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatDefaultDisableNotification
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatGiftNotifications
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatHasProtectedContent
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatIsMarkedAsUnread
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatIsPinned
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatIsTranslatable
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleChatViewAsTopics
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleForumTopicIsClosed
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleForumTopicIsPinned
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGeneralForumTopicIsHidden
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.transferChatOwnership
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.translateMessageText
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.unpinAllChatMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.unpinAllMessageThreadMessages
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.unpinChatMessage
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.upgradeBasicGroupChatToSupergroupChat
...
interface ChatKtx : BaseKtx {
   ...
   * messageProperties.canBeSaved and messageProperties.canBeCopiedToSecretChat to check whether the
   * message is suitable.  
   ...
   * canEditStories right in the chat. The stories are returned in reverse chronological order (i.e.,
   ...
   * messageChatSetBackground, messageGiveawayCompleted and topic messages without non-bundled replied
  ...
  /**
   * Suspend function, which returns RTMP URL for streaming to the chat; requires
  ...
  suspend fun Chat.openWebApp(
    ...
    replyTo: InputMessageReplyTo?,
    parameters: WebAppOpenParameters?
  ) = api.openWebApp(this.id, botUserId, url, messageThreadId, replyTo, parameters)
