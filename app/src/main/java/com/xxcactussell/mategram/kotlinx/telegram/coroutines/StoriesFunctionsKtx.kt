 ...
 * specified limit.
 *
 * @param storySenderChatId Identifier of the chat that posted the stories to search for; pass 0 to
...
suspend fun TelegramFlow.searchPublicStoriesByTag(
  ...
  offset: String?,
  limit: Int
): FoundStories = this.sendFunctionAsync(TdApi.SearchPublicStoriesByTag(storySenderChatId, tag,
    offset, limit))
