...
) = this.sendFunctionLaunch(TdApi.EditStoryCover(storySenderChatId, storyId, coverFrameTimestamp))
...
suspend fun TelegramFlow.reportStory(
  ...
  optionId: ByteArray?,
  text: String?
): ReportStoryResult = this.sendFunctionAsync(TdApi.ReportStory(storySenderChatId, storyId,
    optionId, text))
