...
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.endGroupCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.endGroupCallRecording
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.endGroupCallScreenSharing
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getGroupCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getGroupCallInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getGroupCallStreamSegment
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.getGroupCallStreams
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.inviteGroupCallParticipants
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.joinGroupCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.leaveGroupCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.loadGroupCallParticipants
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.revokeGroupCallInviteLink
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setGroupCallParticipantIsSpeaking
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setGroupCallParticipantVolumeLevel
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.setGroupCallTitle
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.startGroupCallRecording
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.startGroupCallScreenSharing
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.startScheduledGroupCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallEnabledStartNotification
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallIsMyVideoEnabled
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallIsMyVideoPaused
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallMuteNewParticipants
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallParticipantIsHandRaised
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallParticipantIsMuted
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.toggleGroupCallScreenSharingIsPaused
...
interface GroupCallKtx : BaseKtx {
   ...
   */
  suspend fun GroupCall.createCall(
    userId: Long,
    protocol: CallProtocol?,
    isVideo: Boolean
  ) = api.createCall(userId, protocol, isVideo, this.id)
   ...
   * @param keyFingerprint Fingerprint of the encryption key for E2E group calls not bound to a
