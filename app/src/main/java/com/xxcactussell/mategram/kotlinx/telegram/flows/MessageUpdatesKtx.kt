...
fun TelegramFlow.newMessageFlow(): Flow<Message> =
    this.getUpdatesFlowOfType<UpdateNewMessage>()
...
fun TelegramFlow.savedMessagesTopicFlow(): Flow<SavedMessagesTopic> =
    this.getUpdatesFlowOfType<UpdateSavedMessagesTopic>()
    .mapNotNull { it.topic }
...
fun TelegramFlow.webAppMessageSentFlow(): Flow<Long> =
    this.getUpdatesFlowOfType<UpdateWebAppMessageSent>()
...
fun TelegramFlow.activeLiveLocationMessagesFlow(): Flow<Array<Message>> =
    this.getUpdatesFlowOfType<UpdateActiveLiveLocationMessages>()
