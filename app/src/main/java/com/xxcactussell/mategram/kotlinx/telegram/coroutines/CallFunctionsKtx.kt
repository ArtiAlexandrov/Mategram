 ...
 * @param groupCallId Identifier of the group call to which the user will be added after exchanging
...
suspend fun TelegramFlow.createCall(
  ...
  isVideo: Boolean,
  groupCallId: Int
): CallId = this.sendFunctionAsync(TdApi.CreateCall(userId, protocol, isVideo, groupCallId))
 ...
 * @param callId Call identifier.
 */
suspend fun TelegramFlow.createGroupCall(callId: Int) =
    this.sendFunctionLaunch(TdApi.CreateGroupCall(callId))
 ...
 * by administrators.  
 * @param keyFingerprint Fingerprint of the encryption key for E2E group calls not bound to a chat;
 * pass 0 for voice chats.
 *
...
suspend fun TelegramFlow.joinGroupCall(
  ...
  keyFingerprint: Long
    ...
    payload, isMuted, isMyVideoEnabled, inviteHash, keyFingerprint))
