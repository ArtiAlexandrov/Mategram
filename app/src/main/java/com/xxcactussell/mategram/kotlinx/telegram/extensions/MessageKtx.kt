...
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.blockMessageSenderFromReplies
...
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.editQuickReplyMessage
...
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.reportSupergroupAntiSpamFalsePositive
...
interface MessageKtx : BaseKtx {
   ...
   * can be edited only to a media message. The type of message content in an album can't be changed
