...
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.acceptCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.createGroupCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.discardCall
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendCallDebugInformation
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendCallLog
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendCallRating
import com.xxcactussell.mategram.kotlinx.telegram.coroutines.sendCallSignalingData
...
interface CallKtx : BaseKtx {
  ...
  /**
   * Suspend function, which creates a group call from a one-to-one call.
   */
  suspend fun Call.createGroup() = api.createGroupCall(this.id)
